...
const AuthSignUp = () => {
    ...
    const [cookies, setCookie, removeCookie] = useCookies(["kakaoAuth"]);
    ...
    useEffect(() => {
        ...
        console.log(cookies.kakaoAuth);


        // setSignUpForm({
        //     ...signUpForm,
        //     email: cookies.kakaoAuth.kakao_account.email,
        //     name: cookies.kakaoAuth.kakao_account.profile.nickname,
        // })
